...
public class ConfigurarPartidaController {
    ...
    private void onComenzarPartida() {
        try {
            ...
            // Generar el archivo HTML con los datos de ambos jugadores y guardarlo en el escritorio
            String nombreArchivo = System.getProperty("user.home") + File.separator + "Desktop" + File.separator + "datos_partida.html";
    ...
    private void guardarArchivoHTML(String nombreFichero, Jugador jugador1, Jugador jugador2) {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(nombreFichero))) {
            ...
            // Estilos CSS
            bw.write("body { font-family: Arial, sans-serif; background-color: #f4f4f9; color: #333; margin: 0; padding: 20px; }");
            bw.newLine();
