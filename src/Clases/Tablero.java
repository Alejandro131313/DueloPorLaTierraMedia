...
/**
 * Representa el tablero central del juego Duelo por la Tierra Media.
 * 
 * Esta clase se encarga de:
 * 
 * Gestionar las cartas del juego, divididas por fases (capítulos). Inicializar,
 * mezclar y repartir cartas y lugares clave. Aplicar los efectos de cartas y
 * lugares clave sobre los jugadores. Comprobar si los jugadores cumplen los
 * requisitos para jugar cartas o conquistar lugares.
 *
 * 
 * Cada tablero contiene un conjunto de cartas repartidas entre tres capítulos
 * (fase1, fase2, fase3), así como una colección de lugares clave únicos que los
 * jugadores pueden intentar conquistar si cumplen los requisitos
 * correspondientes.
 * 
 * Las cartas tienen efectos diversos: otorgar recursos, sumar razas, permitir
 * avanzar en la misión(carrera)...
 * 
 * Esta clase también incluye métodos utilitarios para buscar cartas por ID,
 * aplicar efectos, verificar requisitos de recursos y más.
 * 
 * @author Alejandro
 * @version 1.0
 */
 ...
 *
 * Este constructor inicializa el tablero con un ID, una disposición de cartas y
 * un capítulo inicial. También carga todas las cartas disponibles, las divide
 * por fases (fase1, fase2, fase3), mezcla los mazos y carga los lugares clave.
 * 
 * 
 * Deja el tablero listo para empezar la partida.
 *
 * @param idTablero         Identificador único del tablero.
 * @param disposicionCartas Tipo de disposición de las cartas (puede afectar la
 *                          lógica visual o de juego).
 * @param capitulo          Capítulo o fase actual del tablero (por ejemplo "fase1").
 */

	public Tablero(final int idTablero, final String disposicionCartas, final String capitulo) {
	...
	/*
	 * public List<Razas> getRazas() { return razas; } private Map<Razas, Integer>
	 * fichasDisponibles;
	 */
	...
	public void setId(final int idTablero) {
		this.idTablero = idTablero;
	}
	...
	public void setDisposicionCartas(final String disposicionCartas) {
		this.disposicionCartas = disposicionCartas;
	}
	...
	public void setCapitulo(final String capitulo) {
		this.capitulo = capitulo;
	}
	...
	private void inicializarCartas() {
		...
		cartas.add(new Carta(13, "Batalla1", "Roja", "1 astucia", "Rohan+1 || Gondor+1", "fase1",
				("/Images/Cartas/1.13.png")));
		cartas.add(new Carta(14, "Batalla2", "Roja", "0", "Enedwatih+1 || Rhovanion+1", "fase1",
				("/Images/Cartas/1.14.png")));
		cartas.add(
				new Carta(15, "Batalla3", "Roja", "0", "Lindon +1 || Arnor+1", "fase1", ("/Images/Cartas/1.15.png")));
		...
		cartas.add(new Carta(27, "RecursoCoronaSabiduria1", "Gris", "1 oro && 1 astucia", "corona+1 || sabiduria+1",
				"fase2", "/Images/Cartas/2.4.png"));
		cartas.add(new Carta(28, "RecursoFuerza3", "Gris", "1 oro", "fuerza+2", "fase2", "/Images/Cartas/2.5.png"));
		cartas.add(new Carta(29, "RecursoAstuciaFuerzaValor1", "Gris", "1 oro && 1 corona && 1 sabiduria",
				"astucia+1 || fuerza+1 || valor+1", "fase2", "/Images/Cartas/2.6.png"));
		cartas.add(new Carta(30, "RecursoValor3", "Gris", "1 oro", "valor+2", "fase2", "/Images/Cartas/2.7.png"));
		cartas.add(new Carta(31, "RazaElfos2", "Verde", "1 valor && 1 corona && 1 sabiduria", "elfos+1", "fase2",
				"/Images/Cartas/2.8.png"));
		cartas.add(new Carta(32, "RazaEnanos2", "Verde", "2 fuerza && 1 valor", "enanos+1", "fase2",
				"/Images/Cartas/2.9.png"));
		cartas.add(new Carta(33, "RazaHumanos2", "Verde", "2 valor && 1 sabiduria", "humanos+1", "fase2",
				"/Images/Cartas/2.10.png"));
		cartas.add(new Carta(34, "RazaHobbits2", "Verde", "2 astucia && 1 corona", "hobbits+1", "fase2",
				"/Images/Cartas/2.11.png"));
		cartas.add(new Carta(35, "Batalla4", "Roja", "2 valor && 1 corona", "Arnor+2 || Rhovanion+2", "fase2",
				"/Images/Cartas/2.12.png"));
		cartas.add(new Carta(36, "Batalla5", "Roja", "1 astucia && 1 fuerza && 1 valor", "Lindon+2 || Rhovanion+2",
				"fase2", "/Images/Cartas/2.13.png"));
		cartas.add(new Carta(37, "Batalla6", "Roja", "2 fuerza && 1 valor", "Lindon+2 || Enedwaith+2", "fase2",
				"/Images/Cartas/2.14.png"));
		cartas.add(new Carta(38, "Batalla7", "Roja", "2 astucia && 1 sabiduria", "Mordor+2 || Rohan+2", "fase2",
				"/Images/Cartas/2.15.png"));
		cartas.add(new Carta(39, "Batalla8", "Roja", "3 astucia", "Gondor+2 || Mordor+2", "fase2",
				"/Images/Cartas/2.16.png"));
		cartas.add(new Carta(40, "Mision5", "Azul", "1 oro", "avance+1", "fase2", "/Images/Cartas/2.17.png"));
		cartas.add(new Carta(41, "Mision6", "Azul", "1 astucia && 1 fuerza", "avance+1", "fase2",
				"/Images/Cartas/2.18.png"));
		cartas.add(new Carta(42, "Mision7", "Azul", "1 valor && 1 fuerza", "avance+1", "fase2",
				"/Images/Cartas/2.19.png"));
		cartas.add(new Carta(43, "Mision8", "Azul", "2 fuerza && 1 sabiduria", "avance+2", "fase2",
				"/Images/Cartas/2.20.png"));
		cartas.add(new Carta(44, "Mision9", "Azul", "1 fuerza && 2 valor", "avance+2", "fase2",
				"/Images/Cartas/2.21.png"));
		...
		cartas.add(new Carta(47, "RazaMagos1", "Verde", "2 astucia && 2 corona", "magos+1", "fase3",
				"/Images/Cartas/3.1.png"));
		cartas.add(new Carta(48, "RazaMagos2", "Verde", "2 fuerza && 1 corona && 1 sabiduria", "magos+1", "fase3",
				"/Images/Cartas/3.2.png"));
		cartas.add(new Carta(49, "RazaEnts1", "Verde", "2 fuerza && 2 sabiduria", "ents+1", "fase3",
				"/Images/Cartas/3.3.png"));
		cartas.add(new Carta(50, "RazaEnts2", "Verde", "2 valor && 1 corona && 1 sabiduria", "ents+1", "fase3",
				"/Images/Cartas/3.4.png"));
		cartas.add(new Carta(51, "Batalla9", "Roja", "1 astucia && 1 fuerza && 2 corona && 1 sabiduria",
				"Gondor+3 || Arnor+3", "fase3", "/Images/Cartas/3.5.png"));
		cartas.add(new Carta(52, "Batalla10", "Roja", "2 fuerza && 2 valor", "Enedwaith+3 || Rohan+3", "fase3",
				"/Images/Cartas/3.6.png"));
		cartas.add(new Carta(53, "Batalla11", "Roja", "2 astucia && 1 valor && 2 sabiduria", "Lindon+3 || Mordor+3",
				"fase3", "/Images/Cartas/3.7.png"));
		cartas.add(new Carta(54, "Batalla12", "Roja", "3 astucia && 2 corona", "Rhovanion+3 || Gondor+3", "fase3",
				"/Images/Cartas/3.8.png"));
		cartas.add(new Carta(55, "Batalla13", "Roja", "2 astucia && 2 valor", "Enedwaith+3 || Arnor +3", "fase3",
				"/Images/Cartas/3.9.png"));
		cartas.add(new Carta(56, "Batalla14", "Roja", "1 astucia && 2 fuerza && 2 valor", "Rhovanion+3 || Mordor+3",
				"fase3", "/Images/Cartas/3.10.png"));
		cartas.add(new Carta(57, "Mision10", "Azul", "3 astucia && 1 valor", "avance+2", "fase3",
				"/Images/Cartas/3.11.png"));
		cartas.add(new Carta(58, "Mision11", "Azul", "2 fuerza && 1 corona", "avance+2", "fase3",
				"/Images/Cartas/3.12.png"));
		cartas.add(new Carta(59, "Mision12", "Azul", "1 astucia && 3 fuerza", "avance+2", "fase3",
				"/Images/Cartas/3.13.png"));
		cartas.add(new Carta(60, "Mision13", "Azul", "2 astucia && 2 valor", "avance+2", "fase3",
				"/Images/Cartas/3.14.png"));
		cartas.add(new Carta(61, "Mision14", "Azul", "3 oro", "avance+3", "fase3", "/Images/Cartas/3.15.png"));
		cartas.add(new Carta(62, "Oro7", "Amarilla", "1 astucia && 1 corona && 1 sabiduria", "oro+5", "fase3",
				"/Images/Cartas/3.16.png"));
		cartas.add(
				new Carta(63, "Oro8", "Amarilla", "2 astucia && 1 valor", "oro+5", "fase3", "/Images/Cartas/3.17.png"));
		cartas.add(new Carta(64, "Sabotaje1", "Morada", "3 valor && 1 corona", "soldado-1 && oro-2", "fase3",
				"/Images/Cartas/3.18.png"));
		cartas.add(new Carta(65, "Sabotaje2", "Morada", "2 valor && 1 corona && 1 sabiduria", "movimiento3", "fase3",
				"/Images/Cartas/3.19.png"));
		cartas.add(new Carta(66, "Sabotaje3", "Morada", "1 astucia && 1 fuerza && 1 valor && 1 sabiduria",
				"oro-1 && movimiento2", "fase3", "/Images/Cartas/3.20.png"));
		cartas.add(new Carta(67, "Sabotaje4", "Morada", "2 fuerza && 1 corona", "soldado-1 && oro-2 && movimiento1",
				"fase3", "/Images/Cartas/3.21.png"));
		cartas.add(new Carta(68, "Sabotaje5", "Morada", "3 fuerza && 1 sabiduria", "soldado-1 && movimiento2", "fase3",
				"/Images/Cartas/3.22.png"));
		cartas.add(new Carta(69, "Sabotaje6", "Morada", "1 fuerza && 1 valor && 1 sabiduria", "soldado-2 && oro-1",
				"fase3", "/Images/Cartas/3.23.png"));
	...
	public void mezclarCartasCapitulos() {
		...
		// Eliminar las 3 últimas cartas de cada lista si tienen más de 3 cartas para
		// evitar errores
	...
	public Carta robarCarta(final String capitulo) {
	...
	public void eliminarCartaFase(Carta carta) {
		switch (capitulo) {
		case "fase1":
			cartasCapitulo1.remove(carta);
			break;
		case "fase2":
			cartasCapitulo2.remove(carta);
			break;
		case "fase3":
			cartasCapitulo3.remove(carta);
			break;
		default:
	...
	public void inicializarLugaresClave() {
		...
		lugaresclave.add(new LugarClave(1, "Territorio Arnor", "3fuerza + 2valor +1corona",
				"TorreArnor+soldado2+2movimiento", "/Images/LugarClave/TerritorioArnor.png"));
		lugaresclave.add(new LugarClave(2, "Territorio Enedwaith", "2astucia+3valor+1sabiduria",
				"TorreEnedwaith+avance+1", "/Images/LugarClave/TerritorioEnedwaith.png"));
		lugaresclave.add(new LugarClave(3, "Territorio Gondor", "3astucia+1fuerza+2sabiduria", "TorreGondor+avance+2",
				"/Images/LugarClave/TerritorioGondor.png"));
		lugaresclave.add(new LugarClave(4, "Territorio Lindon", "3fuerza+2corona+1sabiduria", "TorreLindon",
				"/Images/LugarClave/TerritorioLindon.png"));
		lugaresclave.add(new LugarClave(5, "Territorio Mordor", "3valor+2corona+1sabiduria", "TorreMordor",
				"/Images/LugarClave/TerritorioMordor.png"));
		lugaresclave.add(new LugarClave(6, "Territorio Rhovanion", "1astucia+2fuerza+1valor+1corona+1sabiduria",
				"TorreRhovanion+5oro+1movimiento", "/Images/LugarClave/TerritorioRhovanion.png"));
		lugaresclave.add(new LugarClave(7, "Territorio Rohan", "3astucia+2corona+1sabiduria", "TorreRohan+soldado3",
				"/Images/LugarClave/TerritorioRohan.png"));
	}
	...
	/*
	 * Se comenta este método para futuras versiones public boolean
	 * obtenerFichaDeRaza(String nombreRaza) { for (Razas raza : razas) { if
	 * (raza.getNombre().equalsIgnoreCase(nombreRaza)) { int fichasRestantes =
	 * fichasDisponibles.getOrDefault(raza, 0); if (fichasRestantes > 0) {
	 * fichasDisponibles.put(raza, fichasRestantes - 1); // Resta una ficha return
	 * true; // Ficha obtenida } return false; // Sin fichas disponibles } } return
	 * false; // Raza no encontrada }
	 * 
	 * 
	 * private void initializeRazas() { razas = new ArrayList<>(); razas.add(new
	 * Razas(1, "Hobbits",
	 * getClass().getResource("/Images/Fichas/FichaHobbits.png").toExternalForm()));
	 * razas.add(new Razas(2, "Enanos",
	 * getClass().getResource("/Images/Fichas/FichaEnanos.png").toExternalForm()));
	 * razas.add(new Razas(3, "Humanos",
	 * getClass().getResource("/Images/Fichas/FichaHumanos.png").toExternalForm()));
	 * razas.add(new Razas(4, "Elfos",
	 * getClass().getResource("/Images/Fichas/FichaElfos.png").toExternalForm()));
	 * razas.add(new Razas(5, "Magos",
	 * getClass().getResource("/Images/Fichas/FichaMagos.png").toExternalForm()));
	 * razas.add(new Razas(6, "Ents",
	 * getClass().getResource("/Images/Fichas/FichaEnts.png").toExternalForm()));
	 * 
	 * // Inicializar mapa de fichas disponibles fichasDisponibles = new
	 * HashMap<>(); for (Razas raza : razas) { fichasDisponibles.put(raza, 3); //
	 * Cada raza tiene 3 fichas inicialmente } } public int
	 * consultarFichasDeRaza(String nombreRaza) { for (Razas raza : razas) { if
	 * (raza.getNombre().equalsIgnoreCase(nombreRaza)) { return
	 * fichasDisponibles.getOrDefault(raza, 0); } } return -1; // Raza no encontrada
	 * }
	 */
	...
	public boolean comprobarRecursosFase3(final Carta carta, final JugadorPartida jugador) {
		...
		case "1 astucia && 1 fuerza && 2 corona && 1 sabiduria":
			if (jugador.getAstucia() >= 1 && jugador.getFuerza() >= 1 && jugador.getCorona() >= 2
					&& jugador.getSabiduria() >= 1) {
				return true;
			} else {
	...
	public boolean comprobarRecursosLugarClave(final LugarClave lugar, final JugadorPartida jugador) {
		...
		case "3astucia+2corona+1sabiduria":
